...
class _GeometryDefinerNode(_HermesNode):
    ...
    def initializeFromJson(self, obj):
        ...
        for y in GeometryEntityList:
            ...
            GENodeObj = HermesGeometryDefinerEntity.makeEntityNode('GEtemp', TypeList, GEnum, obj)
    ...
    def doubleClickedNode(self, obj):
        ...
        geDialog = HermesGeometryDefinerEntity.CGEDialogPanel(obj)
    ...
    def geDialogClosed(self, obj, GEtype, GEname):
        ...
        # Create the GEObject
        from . import HermesGeometryDefinerEntity
        GENodeObj = HermesGeometryDefinerEntity.makeEntityNode('GEtemp', TypeList, GENodeData, obj)
        if GENodeObj is None:
            return None
