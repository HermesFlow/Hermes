...
class LuigiBuilder(object):
    ...
    def __init__(self):
        self._mapping = {} # dict(spanParameters=pydoc.locate("pyHermes.transform.spanParameters")())
        #self.WD_path=WD_path

    def _getTransformaer(self, tasktype):
        return self._mapping.get(tasktype, pydoc.locate("pyHermes.engines.luigi.default.transform")())
    ...
    def buildWorkflow(self, workflow):
        ...
        :param workflow:
            A pyHermes.workflow.workflow object.
        :return:
