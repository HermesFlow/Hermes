...
class BlockMesh_0(luigi.Task,hermesutils):
    ...
    def run(self):
        ...
        params['Schema']     = {}
        params['uiSchema']   = {}
        params['Properties'] = {'Property01': {'prop': 'partName', 'init_val': '', 'type': 'App::PropertyString', 'Heading': 'BasicData', 'tooltip': 'Name of tha part of the mesh node ', 'current_val': ''}, 'Property02': {'prop': 'partPath', 'init_val': '', 'type': 'App::PropertyPath', 'Heading': 'BasicData', 'tooltip': 'Path to tha part of the mesh node ', 'current_val': ''}, 'Property03': {'prop': 'convertToMeters', 'init_val': 1, 'type': 'App::PropertyFloat', 'Heading': 'BasicData', 'tooltip': 'Link a part to the mesh node ', 'current_val': 1.0}, 'Property04': {'prop': 'NumberOfCells', 'init_val': '1 2 3', 'type': 'App::PropertyString', 'Heading': 'Block', 'tooltip': 'Numbers of cells in each direction ', 'current_val': '1 2 3'}, 'Property05': {'prop': 'simpleGradingX', 'init_val': ['1'], 'type': 'App::PropertyStringList', 'Heading': 'Block', 'tooltip': 'simpleGrading in x direction ', 'current_val': ['1']}, 'Property06': {'prop': 'simpleGradingY', 'init_val': ['1'], 'type': 'App::PropertyStringList', 'Heading': 'Block', 'tooltip': 'simpleGrading in y direction ', 'current_val': ['0.2 0.3 4', '0.6 0.4 1', '0.2 0.3 0.25']}, 'Property07': {'prop': 'simpleGradingZ', 'init_val': ['1'], 'type': 'App::PropertyStringList', 'Heading': 'Block', 'tooltip': 'simpleGrading in z direction ', 'current_val': ['1']}}
        params['WebGui']     = {}
