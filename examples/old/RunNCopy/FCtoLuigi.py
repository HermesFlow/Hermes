...
class CopyDirectory_0(luigi.Task,hermesutils):
    ...
    def __init__(self,*args,**kwargs): 
        ...
        self._workflowJSON = {'workflow': {'root': None, 'Templates': {}, 'nodeList': ['CopyDirectory', 'RunOsCommand'], 'nodes': {'CopyDirectory': {'Execution': {'type': 'fileSystemExecuters.copyDirectory', 'input_parameters': {'Source': 'mySource', 'Target': 'myTarget'}}, 'GUI': {'Type': 'WebGuiNode', 'Properties': {'Source': {'prop': 'Source', 'init_val': '', 'type': 'App::PropertyPath', 'Heading': 'Parameters', 'tooltip': 'The source directory', 'current_val': ''}, 'Target': {'prop': 'Target', 'init_val': '', 'type': 'App::PropertyPath', 'Heading': 'Parameters', 'tooltip': 'The target directory', 'current_val': ''}}, 'WebGui': {}}}, 'RunOsCommand': {'Execution': {'type': 'fileSystemExecuters.RunOsCommand', 'input_parameters': {'Method': '{Properties.ChooseMethod.current_val}', 'Commands': '{Properties.Commands.current_val}', 'batchFile': '{Properties.batchFile.current_val}', 'OS': 'blockmesh -c {CopyDirectory.output.Source}'}}, 'GUI': {'Type': 'WebGuiNode', 'Properties': {'ChooseMethod': {'prop': 'ChooseMethod', 'init_val': ['Commands list', 'batchFile'], 'type': 'App::PropertyEnumeration', 'Heading': 'Parameters', 'tooltip': 'True-commands, False-file', 'current_val': 'Commands list'}, 'Commands': {'prop': 'Commands', 'init_val': [], 'type': 'App::PropertyStringList', 'Heading': 'Parameters', 'tooltip': 'The OS commands to execute', 'current_val': ["echo 'Here is an example of a shell script'", "echo '1a. File listing'", 'ls', "echo ''"]}, 'batchFile': {'prop': 'batchFile', 'init_val': 'Text', 'type': 'App::PropertyFile', 'Heading': 'Parameters', 'tooltip': 'File containing all the OS commands to execute', 'current_val': ''}}, 'WebGui': {}}}, 'finalnode_xx': {'name': 'finalnode_xx', 'Execution': {'type': 'generalExecuters.parameter', 'input_parameters': {}}, 'requires': ['CopyDirectory', 'RunOsCommand'], 'GUI': {'TypeFC': {}, 'Properties': {}, 'WebGui': {}}}}}}['workflow']
    ...
    def run(self):
        ...
        task_executer_mapping = {'Source': 'mySource', 'Target': 'myTarget'}
        ...
        from hermes.Resources.executers.fileSystemExecuters import copyDirectoryExecuter  
        output = copyDirectoryExecuter(self._taskJSON).run(**executer_parameters)
...
class RunOsCommand_0(luigi.Task,hermesutils):
    ...
    def run(self):
        ...
        task_executer_mapping = {'Method': '{Properties.ChooseMethod.current_val}', 'Commands': '{Properties.Commands.current_val}', 'batchFile': '{Properties.batchFile.current_val}', 'OS': 'blockmesh -c {CopyDirectory.output.Source}'}
        ...
        from hermes.Resources.executers.fileSystemExecuters import RunOsCommandExecuter  
        output = RunOsCommandExecuter(self._taskJSON).run(**executer_parameters)
...
class finalnode_xx_0(luigi.Task,hermesutils):
    ...
    def __init__(self,*args,**kwargs): 
        ...
        self._workflowJSON = {'workflow': {'root': None, 'Templates': {}, 'nodeList': ['CopyDirectory', 'RunOsCommand'], 'nodes': {'CopyDirectory': {'Execution': {'type': 'fileSystemExecuters.copyDirectory', 'input_parameters': {'Source': 'mySource', 'Target': 'myTarget'}}, 'GUI': {'Type': 'WebGuiNode', 'Properties': {'Source': {'prop': 'Source', 'init_val': '', 'type': 'App::PropertyPath', 'Heading': 'Parameters', 'tooltip': 'The source directory', 'current_val': ''}, 'Target': {'prop': 'Target', 'init_val': '', 'type': 'App::PropertyPath', 'Heading': 'Parameters', 'tooltip': 'The target directory', 'current_val': ''}}, 'WebGui': {}}}, 'RunOsCommand': {'Execution': {'type': 'fileSystemExecuters.RunOsCommand', 'input_parameters': {'Method': '{Properties.ChooseMethod.current_val}', 'Commands': '{Properties.Commands.current_val}', 'batchFile': '{Properties.batchFile.current_val}', 'OS': 'blockmesh -c {CopyDirectory.output.Source}'}}, 'GUI': {'Type': 'WebGuiNode', 'Properties': {'ChooseMethod': {'prop': 'ChooseMethod', 'init_val': ['Commands list', 'batchFile'], 'type': 'App::PropertyEnumeration', 'Heading': 'Parameters', 'tooltip': 'True-commands, False-file', 'current_val': 'Commands list'}, 'Commands': {'prop': 'Commands', 'init_val': [], 'type': 'App::PropertyStringList', 'Heading': 'Parameters', 'tooltip': 'The OS commands to execute', 'current_val': ["echo 'Here is an example of a shell script'", "echo '1a. File listing'", 'ls', "echo ''"]}, 'batchFile': {'prop': 'batchFile', 'init_val': 'Text', 'type': 'App::PropertyFile', 'Heading': 'Parameters', 'tooltip': 'File containing all the OS commands to execute', 'current_val': ''}}, 'WebGui': {}}}, 'finalnode_xx': {'name': 'finalnode_xx','type': 'generalExecuters.parameter', 'Execution': { 'input_parameters': {}}, 'requires': ['CopyDirectory', 'RunOsCommand'], 'GUI': {'TypeFC': {}, 'Properties': {}, 'WebGui': {}}}}}}['workflow']
