...
class FvSchemes_0(luigi.Task,hermesutils):
    ...
    def run(self):
        ...
        from hermes.Resources.executers import jinjaExecuterExecuter  
        output =  jinjaExecuterExecuter(self._taskJSON).run(**executer_parameters)
