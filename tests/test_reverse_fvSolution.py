...
@pytest.mark.parametrize(
    ...
    [
        (
            ...
            "/Users/sapiriscfdc/Costumers/Hermes/pipe/caseConfiguration/system/fvSolution",
        ),
        (
            "LargeRoom_2",
...
def test_reverse_fvSolution_against_inputs(tmp_path: Path, case_name: str, input_json_path: str, dict_path: str):
    """
    Compare reversed fvSolution against the expected node from reference inputs.
    """
    ...
    expected = input_json["workflow"]["nodes"]["fvSolution"]

    # Temporary test directory
    system_dir = tmp_path / case_name / "system"
    system_dir.mkdir(parents=True, exist_ok=True)
    dst = system_dir / "fvSolution"
